...
export class BoxService {
  ...
  getBySkuCodeAndLineId(skuCode: string, lineId: string): Observable<ApiResponse<Box[]>> {
    return this.http.get<ApiResponse<Box[]>>(`${this.apiUrl}/GetBySkuLine/${skuCode}/${lineId}`);
  }
